...
setup(
    ...
    install_requires=[
        ...
        "click==7.1.2",
        "click-plugins==1.1.1",
        "cligj==0.7.0; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2' and python_version < '4'",
        "fiona==1.8.17",
        "geopandas==0.8.1",
        "munch==2.5.0",
        "numpy==1.19.2",
    ...
    extras_require={
        "dev": [
            ...
            "prioq==0.2.1; python_version >= '3.5'",
            ...
            "python-dateutil==2.8.1; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2'",
            "pyyaml==5.3.1",
            "pyzmq==19.0.2; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2'",
            "reprit==0.3.0; python_full_version >= '3.5.3'",
            ...
            "virtualenv==20.0.35; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2, 3.3'",
